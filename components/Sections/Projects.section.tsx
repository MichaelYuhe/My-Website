    ...
    <div className="my-16 px-3 font-sen" id="projects">
      ...
      <div className="my-8 flex flex-col items-center justify-center gap-10 xl:flex-row">
        <Link href="https://myboom.tw/" passHref>
          <a
            className="h-[7rem] w-[15rem] cursor-pointer rounded-lg bg-gradient-to-r from-[#D8B4FE] to-[#818CF8] p-1 text-white duration-100 hover:scale-105"
            target="_blank"
        ...
        <Link href="https://github.com/MichaelYuhe/Greenet" passHref>
          <a
            className="h-[7rem] w-[15rem] cursor-pointer rounded-lg bg-gradient-to-r from-[#FDE68A] via-[#FCA5A5] to-[#FECACA] p-1 text-white duration-100 hover:scale-105"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-primary px-2 text-center font-medium">
